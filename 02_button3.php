        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="02_button1.php">Spring(2009)-Summer(2009)</a>
                    <a href="02_button2.php">Spring(2010)-Autumn(2010)</a>
                    <a href="02_button3.php">summer(2011)-Autumn(2011)</a>
                </div>
            </div>
            ...
            <div class="home-content">
                ...
                <table class="button2">
                    ...
                    for ($i = 0; $i <8; $i++) {
                        //SPRING
                        for ($j = 0; $j < 4; $j++) {
                            $sql = "SELECT COUNT(*) FROM section_t WHERE school_title= '$school_name[$j]' AND semester_name='summer' 
                                AND semester_year='2011' AND std_enrolled BETWEEN '$enrolled_size1[$i]' AND '$enrolled_size2[$i]';";
                        ...
                        // //SUMMER
                        for ($l = 0; $l < 4; $l++) {
                            $sql2 = "SELECT COUNT(*) FROM section_t WHERE school_title= '$school_name[$l]' AND semester_name='autumn' 
                            AND semester_year='2011' AND std_enrolled BETWEEN '$enrolled_size1[$i]' AND '$enrolled_size2[$i]';";
