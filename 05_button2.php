            ...
            <div>
                ...
                <table class="button5">
                    ...
                    echo "<tr>
                            <th>Class size</th>
                            <th>IUB Resources</th>
                            <th>" . "$semister1" . " " . "$semister_year1" . "</th>
                            <th>Differance</th>
                            <th>" . "$semister2" . " " . "$semister_year2" . "</th>
                            <th>Difference</th>
                            <th></th>
                        </tr>";
                    ...
                    for ($i = 0; $i < count($class_sizes); $i++) {
                        ...
                        semester_name='$semister1' AND semester_year='$semister_year1' AND roomcapacity=$class_sizes[$i];";
                    ...
                    for ($i = 0; $i < count($cls_size1); $i++) {
                        ...
                        semester_name='$semister1' AND semester_year='$semister_year1' AND roomcapacity BETWEEN $cls_size1[$i] AND $cls_size2[$i];";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
