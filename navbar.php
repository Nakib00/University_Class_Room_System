<!-- Side Navigation pnale  -->
<div class="sidebar">
        <div class="logo-details">
            <i class='carbon:chart-custom'></i>
            <span class="logo_name">TCMS</span>
        </div>
        <ul class="nav-links">
            <li>
