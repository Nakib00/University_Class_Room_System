    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <table class="button2">
                ...
                echo "<tr><th></th><th></th>
                    <th >" . "$semister1" . " " . "$semister_year1" . "</th><th></th><th></th><th></th><th></th><th></th>
                ...
                for ($i = 0; $i < 8; $i++) {
                    //SPRING
                    for ($j = 0; $j < 4; $j++) {
                        $sql = "SELECT COUNT(*) FROM section_t WHERE school_title= '$school_name[$j]' AND semester_name='$semister1' 
                                AND semester_year='$semister_year1' AND std_enrolled BETWEEN '$enrolled_size1[$i]' AND '$enrolled_size2[$i]';";
                    ...
                    // //SUMMER
                    for ($l = 0; $l < 4; $l++) {
                        $sql2 = "SELECT COUNT(*) FROM section_t WHERE school_title= '$school_name[$l]' AND semester_name='$semister2' 
                            AND semester_year='$semister_year2' AND std_enrolled BETWEEN '$enrolled_size1[$i]' AND '$enrolled_size2[$i]';";
