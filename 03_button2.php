            ...
            <div>
                ...
                <table class="center">
                    ...
                    for ($i = 0; $i < count($school_name); $i++) {
                        //sum of enrolled students
                        $sql = "SELECT  SUM(std_enrolled) AS total_enrolled  FROM `section_t` WHERE school_title = '$school_name[$i]' AND semester_name ='$semister1';";
                        ...
                        $sql2 = "SELECT COUNT(*) FROM `section_t` WHERE school_title='$school_name[$i]' AND semester_name='$semister1';";
                        ...
                        //sum of room capacity
                        $sql3 = "SELECT SUM(roomcapacity)  FROM `section_t` AS s, classroom_t As c WHERE s.room_id=c.room_id AND school_title='$school_name[$i]' AND semester_name='$semister1';";
                    ...
                    echo "<tr><td>" . $semister1 . "</td><td>" . $sum_total_enrolled . "</td><td>" . round($sum_avg_enrolled, 2) . "</td><td>" .
                    ...
                    for ($i = 0; $i < count($school_name); $i++) {
                        //sum of enrolled students
                        $sql = "SELECT  SUM(std_enrolled) AS total_enrolled  FROM `section_t` WHERE school_title = '$school_name[$i]' AND semester_name ='$semister2';";
                        ...
                        //number of rows that have school
                        $sql2 = "SELECT COUNT(*) FROM `section_t` WHERE school_title='$school_name[$i]' AND semester_name='$semister2';";
                        ...
                        //sum of room capacity
                        $sql3 = "SELECT SUM(roomcapacity)  FROM `section_t` AS s, classroom_t As c WHERE s.room_id=c.room_id AND school_title='$school_name[$i]' AND semester_name='$semister2';";
                    ...
                    echo "<tr><td>" . $semister2 . "</td><td>" . $sum_total_enrolled2 . "</td><td>" . round($sum_avg_enrolled2, 2) . "</td><td>" .
